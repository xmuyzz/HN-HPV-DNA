...
def interpolate(patient_id, path_to_nrrd, interpolation_type, new_spacing, return_type, output_dir, save_img_format):
    ...
    if output_dir != '':
        save_fn = output_dir + '/' + patient_id + '.' + save_img_format
