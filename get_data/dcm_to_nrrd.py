...
def main():
    ...
    proj_dir = '/mnt/kannlab_rfa/Zezhong/HN-HPV-DNA'
    dataset = 'CBCT'
    dcm_dir = proj_dir + '/' + dataset
    save_dir = proj_dir + '/' + dataset + + '_img/raw_img'
...
def main3():
    ...
    for folder in os.listdir(data_dir):
        ...
        try:
            ...
            print(ID, e)
            bad_data.append(ID)
    print('problematic dcm data:', bad_data)
